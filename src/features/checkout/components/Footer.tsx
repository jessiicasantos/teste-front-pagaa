  ...
  return (
    <footer className="bg-white border-t border-gray-200 mt-5">
      <div className="container max-w-7xl mx-auto px-4 py-6">
        <div className="flex flex-wrap justify-between items-start gap-8 mb-6">
          ...
          <div className="right">
            ...
            <ul className="space-y-2 text-sm text-gray-600 flex gap-4">
              <li>
                <Link to="https://www.instagram.com/pagaa.pagamentos?igsh=cnJwbDU0am16dGR3&utm_source=qr" 
                  target="_blank" 
              ...
              <li>
                <Link to="https://www.linkedin.com/company/pagaa"
                  target="_blank"
        ...
        <div className="copyright border-t pt-5 text-center text-sm text-gray-600">
