            ...
            <ul className="space-y-2 text-sm text-gray-600 flex gap-4">
              <li>
                <Link
                  ...
                  target="_blank"
                  className="group social-link hover:border-transparent hover:bg-gradient-to-br hover:from-purple-600 hover:via-pink-600 hover:to-orange-500"
                >
                  <svg
                    ...
                    className="lucide lucide-instagram group-hover:text-white"
                  >
              ...
              <li>
                <Link
                  ...
                  target="_blank"
                  className="group social-link hover:border-[#1877f2] hover:bg-[#1a1836]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
