...
export function PromoBanner({ onSelectPromo }: PromoBannerProps) {
  return (
    <div
      className="jumbotron w-full bg-gradient-to-r from-purple-600 via-purple-500 to-pink-500 px-2 py-2 cursor-pointer transition-all hover:brightness-110 animate-promo-slide origin-top"
